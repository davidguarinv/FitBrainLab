...
class User(UserMixin, db.Model):
    ...
    top_sport_category = db.Column(db.String(50), nullable=True)  # Optional: most-played sport
    last_sport_update = db.Column(db.DateTime, nullable=True)  # Last update timestamp
    last_week_visited = db.Column(db.Integer, nullable=True)  # Last ISO week visited
    last_year_visited = db.Column(db.Integer, nullable=True)  # Last year visited
