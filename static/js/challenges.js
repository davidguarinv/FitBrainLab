// challenges.js - Complete list of challenges for FitBrainLab

const challenges = [
    // --- EASY (90 × regen_hours=4) ---
    {"id":1,"title":"Inbox March","description":"march in place while clearing 10 emails (7 min)","difficulty":"E","points":60},
    {"id":2,"title":"Stair‑tune","description":"sing your favorite song on the stairs (5 min)","difficulty":"E","points":70},
    {"id":3,"title":"Plant Patrol","description":"water 3 plants, pacing between each (8 min)","difficulty":"E","points":50},
...
// Export challenges for use in other modules
